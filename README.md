...
![Tech Stack](https://img.shields.io/badge/stack-MERN%20%7C%20Socket.io-blue)
...
<img width="100%" alt="AlgoSync Workspace" src="https://github.com/user-attachments/assets/4e8206e5-412f-4503-86ba-582c7cbb3e9d" />
...
1. **Clone the repository**
   ```bash
   git clone [https://github.com/Mithlesh-16/AlgoSync.git](https://github.com/Mithlesh-16/AlgoSync.git)
   cd AlgoSync
   ```
...
- **Name:** Mithlesh Kumar
- **Email:** [Mithlesh.kr.cs@gmail.com](mailto:Mithlesh.kr.cs@gmail.com)
- **Phone:** +91 9508846629
- **Education:** Panjab University Swami Sarvanand Giri Regional Centre, Hoshiarpur, Punjab, India
